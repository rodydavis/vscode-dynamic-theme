export const SCHEME_TEMPLATE = `
{
  ...
  "colors": {
    ...
    "badge.background": "{{primaryContainer}}",
    "badge.foreground": "{{onPrimaryContainer}}",
    ...
    "quickInputList.focusBackground": "{{surfaceBright}}",
    "quickInputList.focusForeground": "{{onSurface}}",
    "quickInputList.focusIconForeground": "{{onSurface}}",
    "quickInputList.background": "{{surfaceDim}}",
    {{#high_contrast}}
